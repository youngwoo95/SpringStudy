...
import com.example.aroungHubJavaSpringBoot.aroundHubSpringBoot.service.impl.ProductServiceImpl;
...
public class ProductControllerTest {
    ...
    void getProductTest() throws Exception{
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.productId").exists()) // json path의 depth가 깊어지면 .을 추가하여 탐색 할 수 있음 (ex : $.productId.productIdName)
    ...
    @Test
    @DisplayName("Product 테스트 생성 테스트")
